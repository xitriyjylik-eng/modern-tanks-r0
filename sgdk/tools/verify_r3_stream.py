...
for token in ('#include "r3_stream_world.h"','R3_worldEnter();','R3_worldLeave();','R3_worldUpdate(input.held);'):
    assert token in main, token

for token in ("R3_VIEW_W_PX 224","R3_VIEW_H_PX 192","R3_CAM_RESPONSE_SHIFT 2","R3_CAM_MAX_STEP_Q8","R3_RING_W 32","R3_RING_H 32","VDP_loadTileData","VDP_setTileMapXY"):
